...
def main():
    ...
    analysis_prune(eval_function, global_config['model_dir'], global_config['model_filename'],
                   global_config['params_filename'], FLAGS.analysis_file,
                   FLAGS.pruned_ratios, FLAGS.target_loss)
